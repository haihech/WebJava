...
<link href="${pageContext.request.contextPath}/resources/css/dataTable/dataTables.bootstrap4.min.css"
	rel="stylesheet">
...
<script src="${pageContext.request.contextPath}/resources/js/dataTable/dataTables.bootstrap.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/dataTable/jquery.dataTables.min.js"></script>
<script src="h${pageContext.request.contextPath}/resources/js/metisMenu.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/sb-admin-2.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/number_format.js"></script>
